...
const App = () => {
  return (
    <div className='pt-3 bg-slate-100 min-h-screen flex flex-col px-5 sm:px-10 items-center'>
      <h1 className='font-title font-extrabold text-4xl py-4 text-center border-slate-300 border-b-3'>
